...
*   **Goal:** The current primary task (based on `plan.md`) is likely implementing or refining the `LiSynchronization` Android app to match the capabilities of the Node.js reference server (`server_able_run.js`), specifically focusing on the QuickJS integration and Xiaomi Wearable communication.
*   **Conventions:**
